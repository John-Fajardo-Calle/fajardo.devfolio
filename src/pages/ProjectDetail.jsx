        ...
        <div className="container mx-auto px-4 py-8 sm:py-12">
            <article className="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
                ...
                <header className="p-6 pt-0 sm:p-8 sm:pt-2 text-center">
                    <FlippableText
                        oldText={flippableTitle.frontText}
                        newText={flippableTitle.backText}
                    ...
                    >
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 dark:text-white">
                            {flippableTitle.isFlipped ? flippableTitle.backText : flippableTitle.frontText}
                        </h1>
                    </FlippableText>
                    {project.category && (
                        ...
                        <section className="pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center space-x-6">
                                ...
                                {project.liveUrl && (
                                    ...
                                    >
                                        <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
